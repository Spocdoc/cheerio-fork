...
var append = exports.append = function () {
    if (typeof arguments[0] === 'function') return el; // not yet supported
    ...
    this.each(function(i, el) {
      var children = el.childNodes || (el.childNodes = []),
          index = children.length;
      Array.prototype.push.apply(children, dom);
      updateDOM(el, index);
    });
...
var prepend = exports.prepend = function () {
    ...
    this.each(function(i, el) {
      var children = el.childNodes || (el.childNodes = []);
      Array.prototype.unshift.apply(children, dom);
      updateDOM(el, 0, domLen+1);
    });
...
var after = exports.after = function() {
  ...
  this.each(function(i, el) {
    ...
    updateDOM(parent, index-1, index + 1 + domLen);
...
var remove = exports.remove = function(selector) {
  ...
  elems.each(function(i, el) {
    ...
    // Update next, prev, and parent pointers
    updateDOM(parent, index-1, index);
...
var replaceWith = exports.replaceWith = function(content) {
  ...
  this.each(function(i, el) {
    ...
    updateDOM(parent, index-1, index + 1 + contentLen);
    el.parentNode = el.nextSibling = el.previousSibling = null;
  });
