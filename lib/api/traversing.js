...
var next = exports.next = function() {
  ...
  var elem = this[0];
  while ((elem = elem.nextSibling)) if (isTag(elem)) return this.make(elem);
  return this.make([]);
};
...
var nextAll = exports.nextAll = function(selector) {
  ...
  while ((elem = elem.nextSibling)) if (isTag(elem)) elems.push(elem);
...
var prev = exports.prev = function() {
  if (!this[0]) { return this; }
  var elem = this[0];
  while ((elem = elem.previousSibling)) if (isTag(elem)) return this.make(elem);
  return this.make([]);
};
...
var prevAll = exports.prevAll = function(selector) {
  if (!this[0]) { return this; }
  var elems = [], elem = this[0];
  while ((elem = elem.previousSibling)) if (isTag(elem)) elems.push(elem);
  return this.make(selector ? select(selector, elems) : elems);
};
...
var children = exports.children = function(selector) {
  ...
  var elems = _.reduce(this, function(memo, elem) {
    return memo.concat(_.filter(elem.childNodes, isTag));
  }, []);
